...
open class DownloadRevealJsBackend : DefaultTask() {
    ...
    val asciidoctorBackendVersion = "master"
    ...
    fun download() {
        ...
        with (VFS()) {
            cp(options,
                "zip:https://github.com/asciidoctor/asciidoctor-reveal.js/archive/$asciidoctorBackendVersion.zip!$asciidoctorBackendDirName",
                downloadDir)
            cp(options,
